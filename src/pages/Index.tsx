      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass-card border-b border-border/50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button className="hidden md:block btn-outline-neon px-4 py-2 rounded-lg text-sm" onClick={() => scrollTo("cabinet")}>
              Войти
            </button>
            <button className="btn-neon px-4 py-2 rounded-lg text-sm" onClick={() => scrollTo("pricing")}>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="glass-card rounded-2xl p-6 border neon-border-cyan">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full flex items-center justify-center text-xl" style={{ background: "rgba(0,245,212,0.2)" }}>👤</div>
                  <div>
                    <div className="font-bold text-sm">Иван Петров</div>
                    <div className="text-xs text-foreground/40">Тарифный план: Команда</div>
                  </div>
                </div>
              ...
              <button className="w-full btn-neon py-3 rounded-xl text-sm font-bold"><span>Войти в кабинет →</span></button>
            </div>
          </div>
        </div>
      </section>
